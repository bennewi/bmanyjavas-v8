package org.wilson.client.samples;
...
import org.wilson.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.wilson.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
