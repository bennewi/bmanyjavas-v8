...
- v8arche01-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- v8arche01-ui: main application module, development time
- v8arche01-production: module that produces a production mode WAR for deployment
